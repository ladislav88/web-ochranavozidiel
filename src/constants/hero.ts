/** Hero pozadie - WebP pre výkon a SEO */
export const HERO_BACKGROUND_IMAGE = '/ochrana-vozidla-zlodej-kradez-auta-hero.webp';

/** Alt text pre hero obrázok - SEO kľúčové slová */

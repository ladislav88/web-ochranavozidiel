    ...
    <section id="contact" className="py-20 md:py-28 bg-gradient-to-b from-secondary/30 to-black/80">
      <div className="max-w-[1140px] mx-auto px-4">
        ...
        <FadeIn direction="up" delay="0.4s">
          <Card className="max-w-[1140px] mx-auto glassmorphism border-t border-blue-500/20 bg-gradient-to-b from-zinc-900/90 to-black/90 shadow-[0_0_25px_rgba(58,134,201,0.15)] rounded-2xl overflow-hidden">
